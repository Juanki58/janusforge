...
**Documento Normativo Nivel 0 (v1.0, congelada)** — Norma Fuente Matrix: Track 1 (*Drug Discovery* / ligando H1–H5, prioritario) vs Track 2 (*Supply Chain* / biomasa y estándares):  
...
- [`docs/guia_maestra_biotecnologia_quimiotipos.md`](docs/guia_maestra_biotecnologia_quimiotipos.md) — **Documento Normativo Nivel 0 v1.0** (Track 1 ligando vs Track 2 supply)
