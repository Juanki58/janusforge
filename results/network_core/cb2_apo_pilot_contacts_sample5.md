...
**Generated (UTC):** `2026-09-12T09:23:11Z`
...
- Single-traj limit: `FALSE_SAMPLE`
- Needs more trajs (stratified zip sample): `OPTIONAL`
...
- `inactive`: `5_trajs` n_atoms=4566 n_frames=2957 n_edges_vdw=1169 sha256=`multi…`
- `active`: `5_trajs` n_atoms=4566 n_frames=2832 n_edges_vdw=1173 sha256=`multi…`
...
- jaccard(inactive, active) = **0.7702**
- n_edges inactive=1169 active=1173
- n_shared=1019 n_union=1323
- frac_private inactive=0.1283 active=0.1313 mean=0.1298
...
- jaccard_ca=0.7393 (not used for verdicts)

## Robustness note

- Primary N=1 traj/state → always `EXT_APO_PILOT_NEEDS_MORE_TRAJS=YES`.
- Optional: extract 5+5 from local `CB2_APO.zip` without full unpack (`--extract-sample 5`) and re-aggregate.
