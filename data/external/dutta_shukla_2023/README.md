# Dutta & Shukla 2023 — registered endpoints
...
**Recovered 2026-09-10 — folder `202821403551`:** es **`Main_Figure_6`** (10 archivos). Box download sigue **403 bandwidth**; seis `CB2_ref_*.pdb` + 2 scripts recuperados desde GitHub raw (tamaños idénticos al listado Box). Ver `main_figure_6/MANIFEST.json`.
